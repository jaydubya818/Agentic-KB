---
id: 01KQ2Y6FEH0YV76PJ3PEXSPZXH
title: "Performance Analyzer Agent"
type: personal
tags: [agents, automation, deployment, architecture]
created: 2026-04-25
updated: 2026-04-25
visibility: private
confidence: high
...
A specialist agent for profiling, benchmarking, and optimizing system performance across backend, frontend, and database layers. It never guesses — every optimization claim is backed by measured before/after data.
...
- Producing before/after benchmarks for any optimization
...
-- Watch for: Seq Scan on large tables, high cost, Rows Removed by Filter
```
...
- [Architecture Agent](../orchestrators/architecture-agent/profile.md)
