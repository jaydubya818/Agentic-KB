...
| `subagent-driven-development` | [[pattern-fan-out-worker]] per task with two-stage review |
...
| `context-compression` | [[pattern-rolling-summary]] compression for long sessions |
